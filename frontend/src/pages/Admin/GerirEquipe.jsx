        ...
        <div className="team-toolbar">
          <div className="team-search-filter-group">
            ...
            <button className={`team-filter-button ${selectedUnit !== 'Todos' || selectedSituation !== 'Todos' ? 'active' : ''}`} type="button" onClick={() => { setPendingUnit(selectedUnit); setPendingSituation(selectedSituation); setShowFilters(true) }}>
              <span>Filtros</span>
              <svg className="team-filter-button-image" aria-hidden="true" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round">
                <line x1="4" y1="6" x2="20" y2="6" /><line x1="8" y1="12" x2="20" y2="12" /><line x1="12" y1="18" x2="20" y2="18" />
                <circle cx="4" cy="6" r="2" fill="currentColor" stroke="none" /><circle cx="8" cy="12" r="2" fill="currentColor" stroke="none" /><circle cx="12" cy="18" r="2" fill="currentColor" stroke="none" />
              </svg>
            </button>
          </div>
