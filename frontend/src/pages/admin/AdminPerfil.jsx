...
function AdminPerfil() {
  ...
  return (
    <section className="page">
      <div>
        <h1>Perfil</h1>
        <p className="page-subtitle">Dados da conta e informa̵̤es do saḷo.</p>
      </div>
      ...
      <div className="card" style={{ display: 'grid', gap: '1rem' }}>
        ...
        <div style={{ display: 'grid', gap: '0.6rem' }}>
          ...
          <button className="btn btn-admin-perfil" type="button" onClick={uploadAvatar}>
            Atualizar avatar
          </button>
        </div>
        <input
        ...
        <textarea
          className="search"
          placeholder="Sobre (admin/profissional)"
          rows={4}
          value={form.about}
          onChange={(e) => setForm((prev) => ({ ...prev, about: e.target.value }))}
        />
        <button className="btn btn-admin-perfil" type="button" onClick={saveProfile}>
          Salvar perfil
        </button>
      </div>
      ...
      <div className="card" style={{ display: 'grid', gap: '1rem' }}>
        ...
        />
        <button className="btn btn-admin-perfil" type="button" onClick={changePassword}>
          Atualizar senha
        </button>
      </div>
