...
import { getBusinessHours, updateBusinessHours, getInstagramPosts, updateInstagramPosts } from './settings.controller.js';
...
router.put('/instagram-posts', authMiddleware, allowRoles('admin'), updateInstagramPosts);
